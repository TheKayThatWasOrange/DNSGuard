...
[^1]: Bear in mind that **Chrome** has its own fucking DNS settings because of course it does. Gotta make sure you can download all the latest multi-gig Gemini models so `pornhu` autocompletes at the speed of light.
